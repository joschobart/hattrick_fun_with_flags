...
def settings():
    ...
    if g.my_document["settings"]["meta"]["schema_version"] < g.db_settings["meta"]["schema_version"]:
        for object in g.db_settings["objects"].items():
            ...
            for item_key in object[1]['schema']:
                ...
                if not item_key in g.my_document["settings"][object[0]]:
                    g.my_document["settings"][object[0]][item_key] = g.db_settings["defaults"][object[0]][item_key]

        g.my_document["settings"]["meta"]["schema_version"] = g.db_settings["meta"]["schema_version"]
        something_changed = True
